...
import type { TooldeckDatabase } from "@/storage/database";
import type { PluginInstallRow } from "@/storage/repositories/types";
import { pluginInstalls } from "@/storage/schema";
